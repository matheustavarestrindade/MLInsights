...
const PaymentGatewayMercadoPago = () => {
        ...
        <div className="col-12">
            <div className="card">
                <div className="card-body">
                    <h3 className="card-title d-flex mb-0" style={{ cursor: "pointer" }} ref={modalRef}>
                        Gateway
                        <span className="ms-auto">
                            <MercadoPagoSvg />
                        </span>
                    </h3>
                    <CollapseField buttonRef={modalRef}></CollapseField>
                </div>
            </div>
        </div>
    );
...
const MercadoPagoSvg = () => {
    return (
        <MercadoPagoSvgStyle>
            <svg xmlns="http://www.w3.org/2000/svg" version="1.1" id="svg2477" x="0" y="0" viewBox="0 0 1000 260.6" style={{ enableBackground: "new 0 0 1000 260.6" }} xmlSpace="preserve">
...
const MercadoPagoSvgStyle = styled.div`
    width: 120px;
...
export default PaymentGatewayMercadoPago;
